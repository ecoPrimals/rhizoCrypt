...
- Real binaries at `/path/to/ecoPrimals/primalBins/`
...
**References**:
- Songbird: `/path/to/ecoPrimals/phase1/songBird/showcase/`
- NestGate: `/path/to/ecoPrimals/phase1/nestGate/showcase/`
- BearDog: `/path/to/ecoPrimals/phase1/bearDog/showcase/`
- ToadStool: `/path/to/ecoPrimals/phase1/toadStool/demos/`

**Binaries**: `/path/to/ecoPrimals/primalBins/`
