...
impl ClientProvider {
    ...
    /// regardless of which service implements it (could be HSM, cloud KMS, software signer, etc.).
    ...
    /// regardless of which service implements it (could be any ledger, distributed storage, etc.).
    ...
    /// regardless of which service implements it (could be any orchestrator or scheduler).
    ...
    /// regardless of which service implements it (could be any attribution ledger, etc.).
