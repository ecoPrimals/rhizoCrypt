...
#[deprecated(
    since = "0.14.0",
    note = "Use `types_ecosystem::compute::ComputeProviderConfig` instead"
)]
...
#[deprecated(
    since = "0.14.0",
    note = "Use `types_ecosystem::compute::ComputeProviderClient` instead"
)]
...
#[deprecated(
    since = "0.14.0",
    note = "Use `types_ecosystem::provenance::ProvenanceProviderConfig` instead"
)]
...
#[deprecated(
    since = "0.14.0",
    note = "Use `types_ecosystem::provenance::ProvenanceNotifier` instead"
)]
...
#[deprecated(
    since = "0.14.0",
    note = "Use `types_ecosystem::provenance::ProvenanceQueryable` trait instead"
)]
