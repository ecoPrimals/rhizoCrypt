...
description = "Ephemeral DAG engine — 1,683 tests, 37 methods, pure Rust, content-addressed working memory for the ecoPrimals ecosystem"
date = 2026-06-04
...
- **1,683 tests** passing (unit + integration + property + doc, `--all-features`)
