...
description = "Ephemeral DAG engine — 1,791 tests, 39 methods, pure Rust, content-addressed working memory for the ecoPrimals ecosystem"
date = 2026-08-04
...
- **1,791 tests** passing (unit + integration + property + doc, `--all-features`)
