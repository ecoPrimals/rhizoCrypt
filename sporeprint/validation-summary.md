...
description = "Ephemeral DAG engine — 1,663 tests, 36 methods, pure Rust, content-addressed working memory for the ecoPrimals ecosystem"
date = 2026-06-02
...
- **1,663 tests** passing (unit + integration + property + doc, `--all-features`)
