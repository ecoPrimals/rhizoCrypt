...
description = "Ephemeral DAG engine — 1,684 tests, 37 methods, pure Rust, content-addressed working memory for the ecoPrimals ecosystem"
date = 2026-06-10
...
- **1,684 tests** passing (unit + integration + property + doc, `--all-features`)
