...
description = "Ephemeral DAG engine — 1,748 tests, 37 methods, pure Rust, content-addressed working memory for the ecoPrimals ecosystem"
date = 2026-06-19
...
- **1,748 tests** passing (unit + integration + property + doc, `--all-features`)
- **190 `.rs` files**, ~58,642 lines
