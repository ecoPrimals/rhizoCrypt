...
description = "Ephemeral DAG engine — 1,807 tests, 39 methods, pure Rust, content-addressed working memory for the ecoPrimals ecosystem"
date = 2026-08-06
...
- **1,807 tests** passing (unit + integration + property + doc, `--all-features`)
- **217 `.rs` files**, ~60,800 lines
