...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let beardog = ServiceEndpoint::new(
        "beardog-alpha",
        "192.168.1.10:8443".parse::<SocketAddr>()?,
    ...
    let nestgate = ServiceEndpoint::new(
        "nestgate-primary",
        "192.168.1.11:7878".parse::<SocketAddr>()?,
    ...
    let loamspine = ServiceEndpoint::new(
        "loamspine-node-1",
        "192.168.1.12:9090".parse::<SocketAddr>()?,
    ...
    let songbird = ServiceEndpoint::new(
        "songbird-tower",
        "192.168.1.1:8080".parse::<SocketAddr>()?,
    ...
    let toadstool = ServiceEndpoint::new(
        "toadstool-gpu-1",
        "192.168.1.20:7777".parse::<SocketAddr>()?,
    ...
    let sweetgrass = ServiceEndpoint::new(
        "sweetgrass-index",
        "192.168.1.21:6060".parse::<SocketAddr>()?,
